...
const columns: ColumnsType<LeaderBoardData & {showModalHistory: (user: string) => void, setLeaderBoard:(data: LeaderBoardData[])=> void} > = [
  {
    title:"",
    dataIndex: "avatar",
    key: 'avatar',
  ...
  },
  {
    ...
    dataIndex: 'subs',
    key: 'subs',
    render: subs => <p>{subs[0]},{subs[1]},{subs[2]}</p>,
  },
  {
    title: 'Time',
    dataIndex: 'time',
    ...
    render: time => {
      ...
      return <p>{year}.{month+1}.{day} {hour}:{minute}</p>
    },
  },
  {
    title: 'Votes',
